...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        city = new QLabel(horizontalLayoutWidget);
        city->setObjectName(QString::fromUtf8("city"));
        city->setAlignment(Qt::AlignCenter);

        table_container->addWidget(city);

        table = new QTableWidget(horizontalLayoutWidget);
        ...
        cities = new QComboBox(horizontalLayoutWidget);
        cities->setObjectName(QString::fromUtf8("cities"));

        charts_container->addWidget(cities);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        city->setText(QApplication::translate("MainWindow", "TextLabel", nullptr));
